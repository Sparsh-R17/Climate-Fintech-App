...
List<Company> companyData = [
  ...
  Company(
    ...
    id: '2',
    img: 'assets/images/water_comp1.png',
    color: AppColor.blue,
  ...
  Company(
    ...
    appBarTitle: 'WATER Related StartUps/NGOs',
    id: '2',
    img: 'assets/images/water_comp2.png',
    color: AppColor.blue,
    accentColor: AppColor.blue.withOpacity(0.63),
    buttonColor: AppColor.iconBlue,
  ...
  Company(
    ...
    appBarTitle: 'WATER Related StartUps/NGOs',
    id: '2',
    img: 'assets/images/water_comp3.png',
    color: AppColor.blue,
    accentColor: AppColor.blue.withOpacity(0.63),
    buttonColor: AppColor.iconBlue,
    email: 'info@wotr.org',
  ...
  Company(
    ...
    id: '3',
    img: 'assets/images/animal_comp1.png',
    color: AppColor.pink,
  ...
  Company(
    ...
    appBarTitle: 'ANIMAL Potection StartUps/NGOs',
    id: '3',
    img: 'assets/images/animal_comp2.png',
    color: AppColor.pink,
    accentColor: AppColor.pink.withOpacity(0.63),
    buttonColor: AppColor.iconPink,
  ...
  Company(
    ...
    appBarTitle: 'ANIMAL Potection StartUps/NGOs',
    id: '3',
    img: 'assets/images/animal_comp3.png',
    color: AppColor.pink,
    accentColor: AppColor.pink.withOpacity(0.63),
    buttonColor: AppColor.iconPink,
    email: 'NA',
